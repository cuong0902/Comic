package com.hyquangcuong.commicapp.database;
...
public class MySQLiteHelper extends SQLiteOpenHelper {
    ...
    private static String DATABASE_NAME = "commic.db";
    ...
    public static final String COLUMN_ID_COMNENT = "id_comment";
    ...
    private String DATABASE_CREATE_COMMENT = "create table "
            + TABLE_COMMENT + "( " + COLUMN_ID_COMNENT + " integer primary key autoincrement" +
            ", " + COLUMN_COMMENT + " text not null )";

    //1: admin, 2:user
    private String SQLQuery2 = "INSERT INTO TaiKhoan VAlUES (null,'admin','Admin@123','admin@gmail.com',1)";
    private String SQLQuery3 = "INSERT INTO TaiKhoan VAlUES (null,'cuong','cuong123456','cuong@gmail.com',2)";
    ...
    public void AddUser(User user){
        ...
        values.put(TEN_TAI_KHOAN,user.getName());
        values.put(MAT_KHAU,user.getPass());
        values.put(EMAIL,user.getEmail());
        values.put(PHAN_QUYEN,user.getRole());

        db.insert(TABLE_TAIKHOAN,null,values);
        db.close();
        Log.e("Add User","Thêm Thành Công");
    }

    public Cursor getAllComic(){
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery("SELECT*FROM " + TABLE_TRUYEN,null);
        //Cursor cursor1 = db.rawQuery("SELECT*FROM " + TABLE_TRUYEN+ " ORDER BY "+ID_TRUYEN+"DESC LIMIT 3",null);
        return cursor;
    }
    public void AddCommic(Truyen truyen)
    {
        ...
        values.put(ID_TAI_KHOAN,truyen.getID_USER());
        db.insert(TABLE_TRUYEN,null,values);
        db.close();
    }
    public int DeleteCommic(int i){
        SQLiteDatabase db = this.getReadableDatabase();
